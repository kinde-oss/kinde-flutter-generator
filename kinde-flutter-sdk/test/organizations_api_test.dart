...
void main() {
  final instance = KindeFlutterSdk().getOrganizationsApi();
  ...
  group(OrganizationsApi, () {
    ...
    //
    //Future<SuccessResponse> updateOrganization(String orgCode, { UpdateOrganizationRequest updateOrganizationRequest }) async

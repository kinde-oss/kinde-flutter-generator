...
class RolesApi {
  ...
  ///
  /// Parameters:
  /// * [createRoleRequest] - Role details.
  ...
  Future<Response<GetRolesResponse>> getRoles({ 
    ...
    GetRolesResponse? _responseData;
    ...
    return Response<GetRolesResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UpdateRolePermissionsResponse>> updateRolePermissions({ 
    ...
    final _path = r'/api/v1/roles/{role_id}/permissions'.replaceAll('{' r'role_id' '}', roleId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateRolePermissionsRequest);
      _bodyData = _serializers.serialize(updateRolePermissionsRequest, specifiedType: _type);
    ...
    UpdateRolePermissionsResponse? _responseData;
  ...
  /// Parameters:
  /// * [roleId] - The identifier for the role.
  /// * [updateRolesRequest] - Role details.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<SuccessResponse>> updateRoles({ 
    ...
    try {
      const _type = FullType(UpdateRolesRequest);
      _bodyData = updateRolesRequest == null ? null : _serializers.serialize(updateRolesRequest, specifiedType: _type);

...
class ConnectedAppsApi {
  ...
  Future<Response<ConnectedAppsAuthUrl>> getConnectedAppAuthUrl({ 
    ...
    final _path = r'/api/v1/connected_apps/auth_url';
    ...
    ConnectedAppsAuthUrl? _responseData;
  ...
  Future<Response<ConnectedAppsAccessToken>> getConnectedAppToken({ 
    ...
    final _path = r'/api/v1/connected_apps/token';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ConnectedAppsAccessToken? _responseData;
  ...
  Future<Response<SuccessResponse>> revokeConnectedAppToken({ 
    ...
    final _path = r'/api/v1/connected_apps/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

...
class UsersApi {
  ...
  Future<Response<CreateUserResponse>> createUser({ 
    ...
    try {
      ...
      _bodyData = createUserRequest == null ? null : _serializers.serialize(createUserRequest, specifiedType: _type);
  ...
  Future<Response<SuccessResponse>> deleteUser({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (isDeleteProfile != null) r'is_delete_profile': encodeQueryParameter(_serializers, isDeleteProfile, const FullType(String)),
    };

...
class SubscribersApi {
  ...
  Future<Response<CreateSubscriberSuccessResponse>> createSubscriber({ 
    ...
    final _path = r'/api/v1/subscribers';
    ...
    CreateSubscriberSuccessResponse? _responseData;
  ...
  Future<Response<GetSubscriberResponse>> getSubscriber({ 
    ...
    final _path = r'/api/v1/subscribers/{subscriber_id}'.replaceAll('{' r'subscriber_id' '}', subscriberId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetSubscriberResponse? _responseData;
  ...
  Future<Response<GetSubscribersResponse>> getSubscribers({ 
    ...
    GetSubscribersResponse? _responseData;

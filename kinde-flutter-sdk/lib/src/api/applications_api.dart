...
class ApplicationsApi {
  ...
  Future<Response<CreateApplicationResponse>> createApplication({ 
    ...
    final _path = r'/api/v1/applications';
    ...
    try {
      const _type = FullType(CreateApplicationRequest);
      _bodyData = createApplicationRequest == null ? null : _serializers.serialize(createApplicationRequest, specifiedType: _type);
    ...
    CreateApplicationResponse? _responseData;
  ...
  Future<Response<GetApplicationResponse>> getApplication({ 
    ...
    final _path = r'/api/v1/applications/{application_id}'.replaceAll('{' r'application_id' '}', applicationId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetApplicationResponse? _responseData;
  ...
  Future<Response<GetApplicationsResponse>> getApplications({ 
    ...
    GetApplicationsResponse? _responseData;
  ...
  Future<Response<void>> updateApplication({ 
    ...
    try {
      const _type = FullType(UpdateApplicationRequest);
      _bodyData = updateApplicationRequest == null ? null : _serializers.serialize(updateApplicationRequest, specifiedType: _type);

...
class CallbacksApi {
  ...
  /// * [replaceRedirectCallbackURLsRequest] - Callback details.
  ...
  Future<Response<SuccessResponse>> addRedirectCallbackURLs({ 
    ...
    final _path = r'/api/v1/applications/{app_id}/auth_redirect_urls'.replaceAll('{' r'app_id' '}', appId.toString());
    ...
    try {
      const _type = FullType(ReplaceRedirectCallbackURLsRequest);
      _bodyData = _serializers.serialize(replaceRedirectCallbackURLsRequest, specifiedType: _type);
  ...
  Future<Response<SuccessResponse>> deleteCallbackURLs({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'urls': encodeQueryParameter(_serializers, urls, const FullType(String)),
    };
  ...
  Future<Response<RedirectCallbackUrls>> getCallbackURLs({ 
    ...
    RedirectCallbackUrls? _responseData;

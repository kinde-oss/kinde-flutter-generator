...
class PermissionsApi {
  ...
  ///
  /// Parameters:
  /// * [createPermissionRequest] - Permission details.
  ...
  Future<Response<SuccessResponse>> createPermission({ 
    ...
    try {
      const _type = FullType(CreatePermissionRequest);
      _bodyData = createPermissionRequest == null ? null : _serializers.serialize(createPermissionRequest, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [permissionId] - The identifier for the permission.
  /// * [createPermissionRequest] - Permission details.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  Future<Response<SuccessResponse>> updatePermissions({ 
    ...
    final _path = r'/api/v1/permissions/{permission_id}'.replaceAll('{' r'permission_id' '}', permissionId.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,

...
class EnvironmentsApi {
  ...
  Future<Response<SuccessResponse>> deleteEnvironementFeatureFlagOverride({ 
    ...
    final _path = r'/api/v1/environment/feature_flags/{feature_flag_key}'.replaceAll('{' r'feature_flag_key' '}', featureFlagKey.toString());
  ...
  Future<Response<SuccessResponse>> deleteEnvironementFeatureFlagOverrides({ 
    ...
    final _path = r'/api/v1/environment/feature_flags';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GetEnvironmentFeatureFlagsResponse>> getEnvironementFeatureFlags({ 
    ...
    GetEnvironmentFeatureFlagsResponse? _responseData;
    ...
    return Response<GetEnvironmentFeatureFlagsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [featureFlagKey] - The identifier for the feature flag.
  /// * [updateEnvironementFeatureFlagOverrideRequest] - Flag details.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<SuccessResponse>> updateEnvironementFeatureFlagOverride({ 
    ...
    try {
      const _type = FullType(UpdateEnvironementFeatureFlagOverrideRequest);
      _bodyData = _serializers.serialize(updateEnvironementFeatureFlagOverrideRequest, specifiedType: _type);

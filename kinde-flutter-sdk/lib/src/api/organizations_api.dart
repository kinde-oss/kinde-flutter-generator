...
class OrganizationsApi {
  ...
  Future<Response<AddOrganizationUsersResponse>> addOrganizationUsers({ 
    ...
    final _path = r'/api/v1/organizations/{org_code}/users'.replaceAll('{' r'org_code' '}', orgCode.toString());
    ...
    try {
      const _type = FullType(AddOrganizationUsersRequest);
      _bodyData = addOrganizationUsersRequest == null ? null : _serializers.serialize(addOrganizationUsersRequest, specifiedType: _type);
    ...
    AddOrganizationUsersResponse? _responseData;
    ...
    return Response<AddOrganizationUsersResponse>(
      data: _responseData,
  ...
  Future<Response<CreateOrganizationResponse>> createOrganization({ 
    ...
    final _path = r'/api/v1/organization';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = createOrganizationRequest == null ? null : _serializers.serialize(createOrganizationRequest, specifiedType: _type);
    ...
    CreateOrganizationResponse? _responseData;
  ...
  Future<Response<SuccessResponse>> createOrganizationUserRole({ 
    ...
    final _path = r'/api/v1/organizations/{org_code}/users/{user_id}/roles'.replaceAll('{' r'org_code' '}', orgCode.toString()).replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateOrganizationUserRoleRequest);
      _bodyData = _serializers.serialize(createOrganizationUserRoleRequest, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [orgCode] - The identifier for the organization.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> deleteOrganization({ 
    ...
    final _path = r'/api/v1/organization/{org_code}'.replaceAll('{' r'org_code' '}', orgCode.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [orgCode] - The identifier for the organization.
  /// * [featureFlagKey] - The identifier for the feature flag.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<SuccessResponse>> deleteOrganizationFeatureFlagOverride({ 
    ...
    final _path = r'/api/v1/organizations/{org_code}/feature_flags/{feature_flag_key}'.replaceAll('{' r'org_code' '}', orgCode.toString()).replaceAll('{' r'feature_flag_key' '}', featureFlagKey.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<SuccessResponse>> deleteOrganizationFeatureFlagOverrides({ 
    ...
    final _path = r'/api/v1/organizations/{org_code}/feature_flags'.replaceAll('{' r'org_code' '}', orgCode.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<SuccessResponse>> deleteOrganizationUserRole({ 
    ...
    final _path = r'/api/v1/organizations/{org_code}/users/{user_id}/roles/{role_id}'.replaceAll('{' r'org_code' '}', orgCode.toString()).replaceAll('{' r'user_id' '}', userId.toString()).replaceAll('{' r'role_id' '}', roleId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GetOrganizationFeatureFlagsResponse>> getOrganizationFeatureFlags({ 
    ...
    GetOrganizationFeatureFlagsResponse? _responseData;
    ...
    return Response<GetOrganizationFeatureFlagsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GetOrganizationsUserRolesResponse>> getOrganizationUserRoles({ 
    ...
    GetOrganizationsUserRolesResponse? _responseData;
    ...
    return Response<GetOrganizationsUserRolesResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [permissions] - Filter by user permissions
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<GetOrganizationUsersResponse>> getOrganizationUsers({ 
    ...
    GetOrganizationUsersResponse? _responseData;
  ...
  Future<Response<GetOrganizationsResponse>> getOrganizations({ 
    ...
    GetOrganizationsResponse? _responseData;
    ...
    return Response<GetOrganizationsResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<SuccessResponse>> removeOrganizationUser({ 
    ...
    final _path = r'/api/v1/organizations/{org_code}/users/{user_id}'.replaceAll('{' r'org_code' '}', orgCode.toString()).replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [orgCode] - The identifier for the organization.
  /// * [updateOrganizationRequest] - Organization details.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<SuccessResponse>> updateOrganization({ 
    ...
    try {
      ...
      _bodyData = updateOrganizationRequest == null ? null : _serializers.serialize(updateOrganizationRequest, specifiedType: _type);
  ...
  Future<Response<UpdateOrganizationUsersResponse>> updateOrganizationUsers({ 
    ...
    try {
      const _type = FullType(UpdateOrganizationUsersRequest);
      _bodyData = updateOrganizationUsersRequest == null ? null : _serializers.serialize(updateOrganizationUsersRequest, specifiedType: _type);
    ...
    UpdateOrganizationUsersResponse? _responseData;
    ...
    return Response<UpdateOrganizationUsersResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

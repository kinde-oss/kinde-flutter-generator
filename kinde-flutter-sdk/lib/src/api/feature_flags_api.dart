...
class FeatureFlagsApi {
  ...
  ///
  /// Parameters:
  /// * [createFeatureFlagRequest] - Flag details.
  ...
  Future<Response<SuccessResponse>> createFeatureFlag({ 
    ...
    final _path = r'/api/v1/feature_flags';
    ...
    try {
      const _type = FullType(CreateFeatureFlagRequest);
      _bodyData = _serializers.serialize(createFeatureFlagRequest, specifiedType: _type);
  ...
  Future<Response<SuccessResponse>> deleteFeatureFlag({ 
    ...
    final _path = r'/api/v1/feature_flags/{feature_flag_key}'.replaceAll('{' r'feature_flag_key' '}', featureFlagKey.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [featureFlagKey] - The key identifier for the feature flag.
